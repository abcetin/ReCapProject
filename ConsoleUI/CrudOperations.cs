...
namespace ConsoleUI
{
    ...
    //    }
    //    public void GetByBrandId(string id)
    //    {
    //        CarManager carManager = new CarManager(new EfCarDal());

    //        var result = carManager.GetCarsByBrandId(id,id);
    ...
    //            {
    //                Console.WriteLine("----------------------------------------------------------- -");
    //                Console.WriteLine("{0} {1} {2} {3} {4}",car.Id, car.CarName, car.UserName, car.RentDate, car.ReturnDate);
    //            }
    //            else
    //            {
    //                Console.WriteLine(result.Message);
